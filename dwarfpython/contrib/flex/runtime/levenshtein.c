...
static long int new_levenshtein_common(char *string1, char *string2, size_t xcost, size_t *lensum)
{
    size_t len1, len2;
...
long int 
distance(char *one, char *two) {
    size_t lensum;
    long int ldist = new_levenshtein_common(one, two, 0, &lensum);
    return ldist;
}

double 
ratio(char * one, char * two) {
    size_t lensum;
    long int ldist = new_levenshtein_common(one, two, 1, &lensum);
    if (lensum == 0)
        return 1.0;
...
hamming(char *str1, char* str2)
{
    ...
    return lev_hamming_distance(len1, str1, str2);
}
double
jaro(char* str1, char* str2)
{
    size_t len1, len2;
    len1 = strlen(str1);
    len2 = strlen(str2);
    return lev_jaro_ratio(len1, str1, len2, str2);
}

double
jaro_winkler_weighted(char* str1, char* str2, double weight)
{
    size_t len1, len2;
    len1 = strlen(str1);
    len2 = strlen(str2);
    ...
    return lev_jaro_winkler_ratio(len1, str1, len2, str2, weight);
}

double
jaro_winkler(char* str1, char* str2)
{
    return jaro_winkler_weighted(str1, str2, 0.1);
}
