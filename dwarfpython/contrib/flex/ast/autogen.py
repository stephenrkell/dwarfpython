...
compulsary = [
    ...
    ['ParathonValue','*evaluate','ParathonContext&'],
    ['void','evaluate_print','ParathonContext&','std::ostream&']
]
...
def usage():
    print >>sys.stderr,"""
        Usage %s <directory>
        Generates 'ast.h' and 'parathon.ll' in the current directory from files
